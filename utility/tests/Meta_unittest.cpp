...
TEST(MetaTest, TypeListChunkOfTest) {
  using R = TypeList<IntType, LongType, FloatType, DoubleType>;

  using U1 = R::chunks_of<1>;
  EXPECT_EQ(U1::length, 4);
  EXPECT_EQ((U1::at<0, 0>::InstanceNonNullable().getTypeID()), kInt);
  EXPECT_EQ((U1::at<1, 0>::InstanceNonNullable().getTypeID()), kLong);
  EXPECT_EQ((U1::at<2, 0>::InstanceNonNullable().getTypeID()), kFloat);
  EXPECT_EQ((U1::at<3, 0>::InstanceNonNullable().getTypeID()), kDouble);

  using U2 = R::chunks_of<2>;
  EXPECT_EQ(U2::length, 2);
  EXPECT_EQ((U2::at<0, 0>::InstanceNonNullable().getTypeID()), kInt);
  EXPECT_EQ((U2::at<0, 1>::InstanceNonNullable().getTypeID()), kLong);
  EXPECT_EQ((U2::at<1, 0>::InstanceNonNullable().getTypeID()), kFloat);
  EXPECT_EQ((U2::at<1, 1>::InstanceNonNullable().getTypeID()), kDouble);

  using U3 = R::chunks_of<3>;
  EXPECT_EQ(U3::length, 2);
  EXPECT_EQ((U3::at<0, 0>::InstanceNonNullable().getTypeID()), kInt);
  EXPECT_EQ((U3::at<0, 1>::InstanceNonNullable().getTypeID()), kLong);
  EXPECT_EQ((U3::at<0, 2>::InstanceNonNullable().getTypeID()), kFloat);
  EXPECT_EQ((U3::at<1, 0>::InstanceNonNullable().getTypeID()), kDouble);

  using U4 = R::chunks_of<8>;
  EXPECT_EQ(U4::length, 1);
  EXPECT_EQ((U4::at<0, 0>::InstanceNonNullable().getTypeID()), kInt);
  EXPECT_EQ((U4::at<0, 1>::InstanceNonNullable().getTypeID()), kLong);
  EXPECT_EQ((U4::at<0, 2>::InstanceNonNullable().getTypeID()), kFloat);
  EXPECT_EQ((U4::at<0, 3>::InstanceNonNullable().getTypeID()), kDouble);
}
...
TEST(MetaTest, StringConstantTest) {
  using R = STR_CONST8("hello");
  using U = STR_CONST8("world");
