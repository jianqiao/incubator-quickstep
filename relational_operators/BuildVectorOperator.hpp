...
#ifndef QUICKSTEP_RELATIONAL_OPERATORS_BUILD_VECTOR_OPERATOR_HPP_
#define QUICKSTEP_RELATIONAL_OPERATORS_BUILD_VECTOR_OPERATOR_HPP_
 ...
 *        relation.
 **/
class BuildVectorOperator : public RelationalOperator {
 public:
  /**
   * @brief Constructor.
   *
   ...
   **/
  BuildVectorOperator(const std::size_t query_id,
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(BuildVectorOperator);
};

/**
 * @brief A WorkOrder produced by BuildVectorOperator
 **/
class BuildVectorWorkOrder : public WorkOrder {
 public:
  /**
   * @brief Constructor.
   *
   ...
   **/
  BuildVectorWorkOrder(const std::size_t query_id,
                     const CatalogRelationSchema &input_relation,
                     const std::vector<attribute_id> &join_key_attributes,
                     const bool any_join_key_attributes_nullable,
                     const partition_id part_id,
                     const block_id build_block_id,
                     CollisionFreeVector *hash_table,
                     StorageManager *storage_manager,
 ...
 private:
  ...
  CollisionFreeVector *hash_table_;
  StorageManager *storage_manager_;

  std::unique_ptr<LIPFilterBuilder> lip_filter_builder_;

  DISALLOW_COPY_AND_ASSIGN(BuildVectorWorkOrder);
};
...
#endif  // QUICKSTEP_RELATIONAL_OPERATORS_BUILD_VECTOR_OPERATOR_HPP_
