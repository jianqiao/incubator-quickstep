...
class BinaryOperation : public Operation {
 public:
   ...
   *        specified types.
   *
   * @param signature The signature of arguments to apply to.
   * @return An UncheckedBinaryOperator which applies this BinaryOperation to
   *         the specified signature.
   **/
  virtual UncheckedBinaryOperator* makeUncheckedBinaryOperatorForSignature(
      const OperationSignaturePtr &signature) const = 0;

  /**
   * @brief Generate expression string of this binary operation applied to the
   *        specified arguments.
   *
   * @param signature The signature of arguments to apply to.
   * @param left The left argument.
   * @param left_precedence The left argument's top level operator precedence.
   * @param right The right argument.
   * @param right_precedence The right argument's top level operator precedence.
   * @param The expression string of this binary operation applied to the
   *        specified arguments.
   */
 ...
 protected:
  BinaryOperation() : Operation(Operation::kBinaryOperation) {}
